...
const defaultTranslations = {
  ...
  auth: {
    ...
    signInDescription: "Chọn phương thức đăng nhập",
    signUpDescription: "Tạo tài khoản để bắt đầu",
    chooseSignInMethod: "Chọn phương thức đăng nhập",
    createAccountToStart: "Tạo tài khoản để bắt đầu",
    passwordsDoNotMatch: "Mật khẩu không khớp",
    passwordTooShort: "Mật khẩu phải có ít nhất 6 ký tự",
    accountCreatedSuccess: "Tạo tài khoản thành công! Đang đăng nhập...",
